...
func stat(opts *FileOptions) (*FileInfo, error) {
	...
	// The scoped filesystem enforces the boundary itself: LstatIfPossible/Stat
	// above return os.ErrPermission for a path whose on-disk target escapes the
	// scope, so no explicit check is needed here.
