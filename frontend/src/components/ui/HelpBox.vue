<template>
  <div
    data-component="help-box"
    class="flex gap-3 bg-blue-50 dark:bg-gray-800 rounded-lg p-4"
  >
    <i class="fa-solid fa-info-circle text-blue-400 dark:text-teal mt-0.5"></i>
